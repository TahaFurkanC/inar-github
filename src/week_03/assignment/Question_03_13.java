...
public class Question_03_13 {
    public static void main(String[] args){
        ...
        System.out.println("Enter the filing status ( 0-single, 1- married jointly or qualifying widow(er)" +
        ...
        if(status == 0) {
            ...
            if (income <= 8350)
                ...
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104452 - 68525) * 0.28 + (income - 104425) * 0.33;
            else
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104452 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (income - 186475) * 0.35;
        }
